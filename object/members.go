...
// (allowRange). A token of unexpected shape for the class is kept best-effort
// and flagged with a Warning rather than dropped.
func (d *decoder) members(name, rule string, allowRange bool) []SetMember {
	var out []SetMember
